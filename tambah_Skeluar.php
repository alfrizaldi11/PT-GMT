        ...
        <div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
                    ...
                    <form role="form" action="aksi_tambah_Skeluar.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="tanggalKeluar" type="date" class="form-control" placeholder="Masukkan Tanggal Keluar Surat"required>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Tujuan</label>
                            <input name="tujuan" type="text" class="form-control" placeholder="Masukkan Tujuan Surat" required>
                        </div>
