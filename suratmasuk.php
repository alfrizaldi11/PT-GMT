...
if (isset($_POST['submit'])) {
    ...
    if (!empty($date1) && !empty($date2)) {
     ...
     $q = mysqli_query($koneksi, "SELECT * FROM suratmasuk WHERE tanggalMasuk BETWEEN '$date1' and '$date2'"); 
    } else {
     // perintah tampil semua data
     $q = mysqli_query($koneksi, "SELECT * FROM suratmasuk"); 
    }
   } else {
    // perintah tampil semua data
    $q = mysqli_query($koneksi, "SELECT * FROM suratmasuk");
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="form-actions">
          <a href="tambah_Smasuk.php"class="btn btn-success" role="button">Tambah Data</a>
          <a href="tampil.php"class="btn btn-default" role="button">Cetak Rekapitulasi Arsip <i class="fa fa-print"></i></a>               
        </div>
        <br>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Data Surat Masuk</div>
					    <div class="panel-body">
                            ...
                            <br>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div> 
                                        <a class="btn btn-warning" href="edit_Smasuk.php?id=<?php echo $data['idSuratMasuk'];?>">Ubah</a> ||
                                        <a class="btn btn-danger" href="aksi_hapus_Smasuk.php?&id=<?php echo $data['idSuratMasuk'];?>"onclick="return confirm('Yakin akan dihapus ?');">Hapus</a>
                                        </div>  
                                    </td>
                                    <td><?php echo $data['nomorSurat']; ?></td>
                                    <td><?php echo date('d-M-Y', strtotime($data['tanggalSurat'])); ?></td>
                                    <td><?php echo date('d-M-Y', strtotime($data['tanggalMasuk'])); ?></td>
                                    <td><?php echo $data['perihal']; ?></td>
                                    <td><?php echo $data['asal']; ?></td>
                                    <td><a href="view.php?id=<?php echo $data['idSuratMasuk'];?>"><?php echo $data['fileMasuk']; ?></a></td>
                                </tr>
                                <?php
                                }
                                ?>
