		...
		<ul class="nav menu">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				...
				<ul class="children collapse" id="sub-item-1">
					...
					<li><a class="active" href="kodeunik.php">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Kelola Kode Unik</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Kelola Kode Unik</h1>
			</div>
        </div><!--/.row-->
        
        <?php
	$edit=mysqli_query($koneksi,"SELECT * FROM kodeunik");
    $hasil = mysqli_fetch_array($edit);
    $idKodeUnik = $hasil['idKodeUnik'];
    $kodeUnik = $hasil['kodeUnik'];
	?>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Edit Kode Unik</div>
					<div class="panel-body">
                    <form enctype='multipart/form-data' action="aksi_edit_kode.php" method="POST">
                    <div class="box-body">
                        <div class="form-group">
                            <label>Kode Unik</label>
                            <input value="<?php echo $kodeUnik; ?>" name="kodeUnik" type="text" class="form-control" placeholder="Masukkan kode unik(jika kosong masukan '-')" required>
                        </div>
