...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <?php
            $edit=mysqli_query($koneksi,"SELECT * FROM jenissuratkeluar where idJenisSurat ='$_GET[id]'");
            $hasil = mysqli_fetch_array($edit);
            $idJenisSurat = $hasil['idJenisSurat'];
            $jenisSurat = $hasil['jenisSurat'];
            $keterangan = $hasil['keterangan'];
        ?>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Edit Jenis Surat</div>
					<div class="panel-body">
                    <form enctype='multipart/form-data' action="aksi_edit_jenis.php" method="POST">
                    <input type="hidden" name="idJenisSurat" value="<?php echo $idJenisSurat; ?>"/>
                    <div class="box-body">
                        <div class="form-group">
                            <label>Jenis Surat</label>
                            <input value="<?php echo $jenisSurat; ?>" name="jenisSurat" type="text" class="form-control" placeholder="Masukkan jenis surat(jika kosong masukan '-')" required>
                        </div>
                        <div class="form-group">
                            <label>Keterangan</label>
                            <input value="<?php echo $keterangan; ?>" name="keterangan" type="text" class="form-control" placeholder="Masukkan keterangan(jika kosong masukan '-')" required>
                        </div>
