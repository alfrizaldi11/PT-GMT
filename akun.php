					    ...
					    <div class="panel-body">
                            `<div class="table-responsive dataTable_wrapper">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div> 
                                        <a class="btn btn-warning" href="edit_akun.php?id=<?php echo $data['idAdmin'];?>">Ubah</a> ||
                                        <a class="btn btn-danger" href="aksi_hapus_akun.php?&id=<?php echo $data['idAdmin'];?>"onclick="return confirm('Yakin akan dihapus ?');">Hapus</a>
                                        </div>  
                                    </td>
                                    <td><?php echo $data['username']; ?></td>
                                    <td><?php echo $data['mypassword']; ?></td>
