...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <?php
            $edit=mysqli_query($koneksi,"SELECT * FROM suratmasuk WHERE idSuratMasuk ='$_GET[id]'");
            $hasil = mysqli_fetch_array($edit);
            $idSuratMasuk = $hasil['idSuratMasuk'];
            $nomorSurat = $hasil['nomorSurat'];
            $tanggalSurat = $hasil['tanggalSurat'];
            $tanggalMasuk = $hasil['tanggalMasuk'];
            $perihal = $hasil['perihal'];
            $asal = $hasil['asal'];
            $myfile = $hasil['fileMasuk'];
        ?>
        <div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Edit Surat Masuk</div>
					<div class="panel-body">
                    <form role="form" action="aksi_edit_Smasuk.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="idSuratMasuk" value="<?php echo $idSuratMasuk; ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo $tanggalSurat; ?>" name="tanggalSurat" type="date" class="form-control" placeholder="Masukkan Keterangan"required>
                        </div>

                        <div class="form-group">
                            <label>Tanggal Masuk</label>
                            <input value="<?php echo $tanggalMasuk; ?>" name="tanggalMasuk" type="date" class="form-control" placeholder="Masukkan Keterangan"required>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Asal</label>
                            <input value="<?php echo $asal; ?>" name="asal" type="text" class="form-control" placeholder="Masukkan Asal Surat" required>
                        </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" name="update "class="btn btn-warning"><i class="fa fa-save"></i>  Ubah Data</button>
