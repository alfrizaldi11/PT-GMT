...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <?php
        	$idSuratMasuk = mysqli_real_escape_string($koneksi,$_GET['id']);
			$sql = "SELECT * FROM suratmasuk WHERE idSuratMasuk='$idSuratMasuk' ";
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
                    ...
                    <input type="hidden" name="idSuratMasuk" value="<?php echo $idSuratMasuk; ?>"/>
                        <embed type="application/pdf" src="filesurat/<?php echo $data['myfile'];?>" width="100%" height="600"></embed>
					</div>
				</div><!-- /.panel-->
